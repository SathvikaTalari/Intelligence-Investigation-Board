...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'vintage-soft': '0 8px 30px rgba(0, 0, 0, 0.5), 0 2px 8px rgba(0, 0, 0, 0.3)',
        'vintage-deep': '0 15px 45px rgba(0, 0, 0, 0.7), 0 6px 15px rgba(0, 0, 0, 0.5)',
        'vintage-pressed': 'inset 0 4px 10px rgba(0, 0, 0, 0.6)',
      },
      borderRadius: {
        'sm': '4px',
        'md': '6px',
